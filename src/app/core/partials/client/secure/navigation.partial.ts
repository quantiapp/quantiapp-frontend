...
@Component({
  ...
  imports: [RouterLink, RouterLinkActive, Dropdownable, Darkable, DrawerComponent, CreateAccountComponent, IconContainerContainer, CreateGoalComponent, CreateTransactionComponent],
  template: `
    ...
    >
        ...
        <div class="items flex flex-col gap-3">
          <q-drawer>
            <ng-template #invoker let-open="open">
              <button (click)="open()" class="item flex w-full text-white justify-between items-center p-4 rounded-2xl bg-(color:--secondary)">
                <div class="content flex gap-4 items-center">
                  <div class="icon w-10 h-10 border border-white rounded-[0.625rem] flex justify-center items-center">
                    <app-icon-container [key]="'card'" [width]="30" [height]="30"></app-icon-container>
                  </div>
                  <div class="content">
                    <p class="text-base">
                      Adicionar conta
          ...
          <q-drawer>
            <ng-template #invoker let-open="open">
              <button (click)="open()" class="item flex w-full text-white justify-between items-center p-4 rounded-2xl bg-(color:--secondary)">
                <div class="content flex gap-4 items-center">
                  <div class="icon w-10 h-10 border border-white rounded-[0.625rem] flex justify-center items-center">
                    <app-icon-container [key]="'big-flag'" [width]="30" [height]="30"></app-icon-container>
                  </div>
                  <div class="content">
                    <p class="text-base">
                      Adicionar meta
          ...
          <q-drawer>
            <ng-template #invoker let-open="open">
              <button (click)="open()" class="item flex w-full text-white justify-between items-center p-4 rounded-2xl bg-(color:--secondary)">
                <div class="content flex gap-4 items-center">
              <div class="icon w-10 h-10 border border-white rounded-[0.625rem] flex justify-center items-center">
                <app-icon-container [key]="'horizontal-arrows'" [width]="30" [height]="30"></app-icon-container>
              </div>
              <div class="content">
      ...
      <nav class="flex justify-around gap-10 items-center">
        ...
        <button [routerLink]="['/secure/settings']" [routerLinkActive]="'active'">
          <svg width="31" height="30" viewBox="0 0 31 30" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  `,
  styles: `
    nav button:not(:nth-child(3)) path{
      stroke: #B3B3B3;
    }
    nav button.active:not(:nth-child(3)) path{
