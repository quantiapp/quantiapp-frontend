...
@Component({
  ...
  imports: [RouterLink, SubmitableButton, MotionedHeight, Darkable],
  template: `
    <section
    data-aos=""
    class="panel-section limited-container flex flex-col gap-5 items-center">
      ...
      <div class="signup-and-otp-auth w-full flex flex-col gap-4">
        ...
        <div class="otp-auth-button">
          <button class="w-full text-sm text-(color:--secondary) border flex gap-4 justify-center items-center border-(color:--secondary)/10 dark:border-(color:--dm-secondary)/10 rounded-[0.563rem] px-2 py-[0.5rem]"
           appDarkable="dark:text-(color:--dm-secondary)"
          >
