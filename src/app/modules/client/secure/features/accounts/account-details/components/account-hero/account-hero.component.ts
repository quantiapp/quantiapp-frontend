...
@Component({
  ...
  template: `
    <app-hero>
      <div class="account-details flex flex-col items p-4 text-(--secondary)" appDarkable="dark:text-(--secondary)">
        <div class="account-name w-full flex gap-2.5 justify-center items-center">
          <h1 class="text-2xl font-medium text-(--secondary)" appDarkable="dark:text-(--secondary)">
        ...
        <div class="account-type mt-2">
          <p class="text-base text-(--secondary) font-medium text-center capitalize" appDarkable="dark:text-(--secondary)">
            {{ account().account.account_type.description }} - {{ account().account.currency.code }}
          </p>
        </div>
        @if (account().account.owner) {
          <div class="account-owner mt-1">
            <p class="text-sm text-(--secondary)/90 font-semibold text-center capitalize" appDarkable="dark:text-(--secondary)/90">
